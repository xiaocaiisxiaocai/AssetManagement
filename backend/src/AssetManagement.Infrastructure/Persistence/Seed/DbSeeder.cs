...
public static class DbSeeder
{
    ...
    public static void Seed(AppDbContext db)
    {
        ...
        var menus = new[]
        {
            ...
            new Menu { Id = 23, ParentId = 4, Name = "ConfirmReturn", Title = "待接收确认", Path = "/approval/confirm-return", Component = "/approval/confirm-return/index", Sort = 23, PermissionCode = "approval:confirm-return" },
