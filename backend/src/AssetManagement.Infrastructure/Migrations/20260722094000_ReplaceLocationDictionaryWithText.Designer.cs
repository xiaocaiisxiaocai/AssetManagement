...
namespace AssetManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260722094000_ReplaceLocationDictionaryWithText")]
    partial class ReplaceLocationDictionaryWithText
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.ApprovalFlow", b =>
                {
                    ...
                    b.Property<int?>("SourceCustodianId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.Asset", b =>
                {
                    ...
                    b.Property<int?>("InitialCustodianId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.FlowRecord", b =>
                {
                    ...
                    b.HasIndex("OperatorUserId", "Action", "OperatedAt");
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.TestMaterialRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaterialId", "OperatedAt");

                    b.ToTable("test_material_records", (string)null);
                });
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.ApprovalFlow", b =>
                {
                    ...
                    b.HasOne("AssetManagement.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("SourceCustodianId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("AssetManagement.Domain.Entities.Asset", b =>
                {
                    ...
                    b.HasOne("AssetManagement.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("InitialCustodianId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
